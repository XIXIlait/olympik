...
const ServiceDetail = () => {
  ...
  const features: FeatureCardProps[] = [
    ...
    },
    {
      ...
      description: 'Nos services sont abordables et accessibles à tous.',
      icon: <FiTrendingUp />,
    },
  ]
  return (
        ...
        <aside className="grid gap-12 place-items-center" data-aos="fade-up-left">
          <div className="sm:w-10/12 md:w-8/12 lg:w-full lg:text-left grid gap-10">
            <div className="grid gap-8">
              <Text
                value={`Déléguez vos idées le plus rapidement possible, créez des designs modernes et des prototypes interactifs. Nos services sont abordables et accessibles à tous.`}
            ...
            <ul className="list-square text-white text-base font-medium pl-5 grid gap-2.5">
              ...
              <li>Services abordables et accessibles</li>
            </ul>
          </div>

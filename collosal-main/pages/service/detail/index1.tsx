  ...
  const features: FeatureCardProps[] = [
    {
      ...
      description: 'Nous développons des applications mobiles pour iOS et Android.',
      icon: <FiSmartphone />,
    },
    {
      title: 'Solutions adaptées aux clients',
      description: 'Nous créons des solutions personnalisées pour répondre à vos besoins.',
      icon: <FiMonitor />,
    },
    {
      title: 'Estimation gratuite',
      description: 'Nous offrons une estimation gratuite pour nos services.',
      icon: <FiGlobe />,
    },
  ]
  return (
        ...
        <aside className="grid gap-12 place-items-center" data-aos="fade-up-left">
          <div className="sm:w-10/12 md:w-8/12 lg:w-full lg:text-left grid gap-10">
            <div className="grid gap-8">
              <Text
                value={`Dites-nous simplement votre problème ou vos idées, et nous ferons une application qui répondra à vos besoins. Nous développons des applications iOS et Android, avec des tests directs sur téléphone et une estimation gratuite.`}
            ...
            <ul className="list-square text-white text-base font-medium pl-5 grid gap-2.5">
              ...
              <li>Solutions adaptées aux clients</li>
